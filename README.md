...
🖼️ This is a tweaked version of the [Caffeine theme](https://github.com/kelyvin/jsonresume-theme-caffeine). Tweaked to fit my design preferences. Published on NPM and GitHub Registry.
...
* `views/resume.hbs` is the order of the resume.
* `views/components/` are the html files for each section
* `app/styles/main.scss` is the styling
* To make changes to the PDF/printable version, make changes in the `@print` section of `app/styles/main.scss`
